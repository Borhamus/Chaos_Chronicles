...
from .views import (
    RegisterView, CustomLoginView, HomeView, CartaListView, DeckListView,
    LeaderboardView, change_deckname, logout_view, deck_create, 
...
urlpatterns = [
    ...
    path('deck/changedeckname/<int:change_deck_id>/', change_deckname, name='change_deckname'),
